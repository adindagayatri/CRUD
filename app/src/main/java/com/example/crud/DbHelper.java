...
public class DbHelper extends SQLiteOpenHelper {
    ...
    static final String DATABASE_NAME = "crud_db";
    public static final String TABLE_SQLite = "crud_tb";
    ...
    public void onCreate(SQLiteDatabase db){
        final String SQL_CREATE_TABLE = "CREATE TABLE "+ TABLE_SQLite + " ("+ COLUMN_ID +
